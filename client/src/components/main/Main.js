      ...
      <div className="main">
        <div className="first">
          <div className="main-text">
            ...
            <p>
              개발새발은 기기 종류와 관계없이 모든 사용자에게 안전하고 품질이
              우수한 화상 회의와 영상 통화 기능을 제공하는 서비스입니다.
            </p>
            <h1>개발새발은 여러분을 위한 것입니다.</h1>
            <p>
              개발새발은 사용자가 연결하고, 커뮤니케이션하고, 아이디어를
              표현함으로써 모두가 함께 더 많은 일을 성취할 수 있도록 지원합니다.
              수백만의 대기업, 중소기업 및 여러분과 같은 수많은 개인 사용자의
              신뢰를 받고 있다는 것이 자랑스럽습니다.
            </p>
          </div>
          <div className="image">
      ...
      <div className="skill">
        ...
        <div className="skillcard">
          ...
          <div className="s-card">
            ...
            <h4>실시간 채팅</h4>
            <p>
              코드 블럭과 코드 펜까지 사용 가능한 개발새발만의 주요 기능입니다.
            </p>
          </div>
        </div>
      </div>
